use crate::juliaup::config_file::{load_config_db, JuliaupConfig, JuliaupConfigChannel};
use crate::juliaup::global_paths::get_paths;
use crate::juliaup::jsonstructs_versionsdb::JuliaupVersionDB;
use crate::juliaup::versions_file::load_versions_db;
...
fn run_versiondb_update(
    config_file: &crate::juliaup::config_file::JuliaupReadonlyConfigFile,
) -> Result<()> {
    use chrono::Utc;
...
fn run_selfupdate(
    _config_file: &crate::juliaup::config_file::JuliaupReadonlyConfigFile,
) -> Result<()> {
    Ok(())
}
